...
namespace Case_Engine
{
	#define DECLARE_CBUFFER_SLOT(name, slot) static constexpr uint16_t CBUFFER_SLOT_##name = slot
	#define DECLARE_TEXTURE_SLOT(name, slot) static constexpr uint16_t TEXTURE_SLOT_##name = slot
