...
namespace Case_Engine
{
	...
	{
		static constexpr uint32_t GetCBufferSize(uint32_t buffer_size)
		{
	...
	public:
		...
		void Update(GfxCommandContext* context, void const* data, uint32_t data_size);
		void Update(GfxCommandContext* context, CBuffer const& buffer_data);

		void Bind(GfxCommandContext* context, GfxShaderStage stage, uint32_t slot) const;
	...
	template<typename CBuffer>
	void GfxConstantBuffer<CBuffer>::Update(GfxCommandContext* context, void const* data, uint32_t data_size)
	{
	...
	template<typename CBuffer>
	void GfxConstantBuffer<CBuffer>::Bind(GfxCommandContext* context, GfxShaderStage stage, uint32_t slot) const
	{
